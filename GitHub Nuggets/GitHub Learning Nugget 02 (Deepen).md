...
<svg xmlns='http://www.w3.org/2000/svg' width='1100' height='400' viewBox='0 0 800 450'>
  ...
  <text x='400' y='130' font-family='Segoe UI, Arial, sans-serif' font-size='35' font-weight='bold' text-anchor='middle' fill='#1A237E'>
    "GitHub Learning Nugget 02 (Deepen)"
  </text>
...
Create a main repository called `Practice-Course` or `course-portfolio`:
...
<video width="100%" height="400" controls autoplay muted>
  <source src="https://raw.githubusercontent.com/OVGU-VET-TechEd/LiaScript_Introduction_Selflearn/b5cfba0fa88ff8f19ce08d487efddaa92086437e/GitHub%20Nuggets/Media/Video%2002.mp4" type="video/mp4">
...
- Videos are set to autoplay with muted audio (required by most browsers)
- The `!?` syntax is LiaScript's native video embedding
- HTML5 video tags provide more control options
- Make sure your videos are accessible via the raw GitHub URLs
